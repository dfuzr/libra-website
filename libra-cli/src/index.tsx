...
import { CommandNames, CommandsArgs, commandsList } from '../../libra-client-sdk-typescript/dist/cli/commands/command';
...
export default function LibraTerminal(Commands: typeof React.Component) {
  ...
  return (
    <div className="d-flex justify-content-stretch">
      ...
      <div
        className="card m-4 border-0 shadow-sm overflow-hidden"
