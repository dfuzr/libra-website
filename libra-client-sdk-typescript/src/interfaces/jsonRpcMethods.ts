...
export interface GetTransactionsMethod
  extends LibraJsonRPCMethod<Transaction[]> {
  method: 'get_transactions';
  params: [BigInt, number, boolean];
}

export interface GetAccountStateMethod
  extends LibraJsonRPCMethod<Account | null> {
  method: 'get_account';
  params: [string];
}

export interface GetAccountTransactionMethod
  extends LibraJsonRPCMethod<Transaction> {
  method: 'get_account_transaction';
  params: [string, BigInt, boolean];
}

export interface GetAccountTransactionsMethod
  extends LibraJsonRPCMethod<Transaction[]> {
...
export interface GetCurrenciesMethod
  extends LibraJsonRPCMethod<CurrencyInfo[]> {
