...
export class AccessPath {
  constructor(public address: AccountAddress, public path: Uint8Array) {}
...
export class AccountAddress {
  constructor(public value: ListTuple<[number]>) {}
...
export class BlockMetadata {
  constructor(
    public id: HashValue,
    public round: BigInt,
    public timestamp_usecs: BigInt,
    public previous_block_votes: Seq<AccountAddress>,
  ...
  public serialize(serializer: Serializer): void {
    ...
    Helpers.serializeVectorAccountAddress(
      this.previous_block_votes,
      serializer
    );
  ...
  static deserialize(deserializer: Deserializer): BlockMetadata {
    ...
    const previous_block_votes = Helpers.deserializeVectorAccountAddress(
      deserializer
    );
...
export class GeneralMetadataV0 {
  constructor(
    public to_subaddress: Optional<Uint8Array>,
    public from_subaddress: Optional<Uint8Array>,
    public referenced_event: Optional<BigInt>
  ) {}
...
export class MetadataVariantUnstructuredBytesMetadata extends Metadata {
  ...
  static load(
    deserializer: Deserializer
  ): MetadataVariantUnstructuredBytesMetadata {
...
export class RawTransaction {
  constructor(
    ...
    public max_gas_amount: BigInt,
    public gas_unit_price: BigInt,
    public gas_currency_code: string,
    public expiration_timestamp_secs: BigInt,
...
export abstract class TravelRuleMetadata {
  ...
  static deserialize(deserializer: Deserializer): TravelRuleMetadata {
    ...
    switch (index) {
      case 0:
        return TravelRuleMetadataVariantTravelRuleMetadataVersion0.load(
          deserializer
        );
      default:
        throw new Error(
          'Unknown variant index for TravelRuleMetadata: ' + index
        );
    }
  }
}
...
export class TravelRuleMetadataV0 {
  constructor(public off_chain_reference_id: Optional<string>) {}
...
export class UnstructuredBytesMetadata {
  constructor(public metadata: Optional<Uint8Array>) {}
...
export class Helpers {
  ...
  static serializeVectorContractEvent(
  ...
  static deserializeVectorContractEvent(
    deserializer: Deserializer
  ): Seq<ContractEvent> {
    const length = deserializer.deserializeLen();
