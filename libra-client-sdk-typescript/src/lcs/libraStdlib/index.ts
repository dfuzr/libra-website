...
export class ScriptCallVariantAddCurrencyToAccount extends ScriptCall {
  constructor(public currency: LibraTypes.TypeTag) {
    super();
  }
}

export class ScriptCallVariantAddRecoveryRotationCapability extends ScriptCall {
  constructor(public recovery_address: LibraTypes.AccountAddress) {
    super();
  }
}

export class ScriptCallVariantAddToScriptAllowList extends ScriptCall {
  constructor(public hash: Uint8Array, public sliding_nonce: BigInt) {
    super();
  }
}
...
export class ScriptCallVariantAddValidatorAndReconfigure extends ScriptCall {
  constructor(
    public sliding_nonce: BigInt,
    public validator_name: Uint8Array,
    public validator_address: LibraTypes.AccountAddress
  ) {
    super();
  }
}
...
export class ScriptCallVariantBurn extends ScriptCall {
  constructor(
    public token: LibraTypes.TypeTag,
    public sliding_nonce: BigInt,
    public preburn_address: LibraTypes.AccountAddress
  ) {
    super();
  }
}
...
export class ScriptCallVariantBurnTxnFees extends ScriptCall {
  constructor(public coin_type: LibraTypes.TypeTag) {
    super();
  }
}
...
export class ScriptCallVariantCreateChildVaspAccount extends ScriptCall {
  constructor(
    public coin_type: LibraTypes.TypeTag,
    public child_address: LibraTypes.AccountAddress,
    public auth_key_prefix: Uint8Array,
    public add_all_currencies: boolean,
    public child_initial_balance: BigInt
  ) {
    super();
  }
}
...
export class ScriptCallVariantCreateDesignatedDealer extends ScriptCall {
  constructor(
    public currency: LibraTypes.TypeTag,
    public sliding_nonce: BigInt,
    public addr: LibraTypes.AccountAddress,
    public auth_key_prefix: Uint8Array,
    public human_name: Uint8Array,
    public add_all_currencies: boolean
  ) {
    super();
  }
...
export class ScriptCallVariantCreateParentVaspAccount extends ScriptCall {
  constructor(
    public coin_type: LibraTypes.TypeTag,
    public sliding_nonce: BigInt,
    public new_account_address: LibraTypes.AccountAddress,
    public auth_key_prefix: Uint8Array,
    public human_name: Uint8Array,
    public add_all_currencies: boolean
  ) {
...
export class ScriptCallVariantFreezeAccount extends ScriptCall {
  constructor(
    public sliding_nonce: BigInt,
    public to_freeze_account: LibraTypes.AccountAddress
  ) {
    super();
  }
}
...
export class ScriptCallVariantPeerToPeerWithMetadata extends ScriptCall {
  constructor(
    public currency: LibraTypes.TypeTag,
    public payee: LibraTypes.AccountAddress,
    public amount: BigInt,
    public metadata: Uint8Array,
    public metadata_signature: Uint8Array
  ) {
    super();
  }
}
...
export class ScriptCallVariantPreburn extends ScriptCall {
  constructor(public token: LibraTypes.TypeTag, public amount: BigInt) {
    super();
  }
}

export class ScriptCallVariantPublishSharedEd25519PublicKey extends ScriptCall {
  constructor(public public_key: Uint8Array) {
    super();
  }
}
...
export class ScriptCallVariantRegisterValidatorConfig extends ScriptCall {
  constructor(
    public validator_account: LibraTypes.AccountAddress,
    public consensus_pubkey: Uint8Array,
    public validator_network_addresses: Uint8Array,
    public fullnode_network_addresses: Uint8Array
  ) {
    super();
  }
}
...
export class ScriptCallVariantRotateAuthenticationKey extends ScriptCall {
  constructor(public new_key: Uint8Array) {
    super();
  }
}

export class ScriptCallVariantRotateAuthenticationKeyWithNonce extends ScriptCall {
  constructor(public sliding_nonce: BigInt, public new_key: Uint8Array) {
    super();
  }
}
...
export class ScriptCallVariantRotateAuthenticationKeyWithRecoveryAddress extends ScriptCall {
  constructor(
    public recovery_address: LibraTypes.AccountAddress,
    public to_recover: LibraTypes.AccountAddress,
    public new_key: Uint8Array
  ) {
    super();
  }
}
...
export class ScriptCallVariantRotateDualAttestationInfo extends ScriptCall {
  constructor(public new_url: Uint8Array, public new_key: Uint8Array) {
    super();
  }
}
...
export class ScriptCallVariantSetValidatorOperator extends ScriptCall {
  constructor(
    public operator_name: Uint8Array,
    public operator_account: LibraTypes.AccountAddress
  ) {
    super();
  }
}
...
export class ScriptCallVariantTieredMint extends ScriptCall {
  constructor(
    public coin_type: LibraTypes.TypeTag,
    public sliding_nonce: BigInt,
    public designated_dealer_address: LibraTypes.AccountAddress,
    public mint_amount: BigInt,
    public tier_index: BigInt
  ) {
    super();
  }
}
...
export class ScriptCallVariantUnfreezeAccount extends ScriptCall {
  constructor(
    public sliding_nonce: BigInt,
    public to_unfreeze_account: LibraTypes.AccountAddress
  ) {
    super();
  }
}
...
export class ScriptCallVariantUpdateDualAttestationLimit extends ScriptCall {
  constructor(
    public sliding_nonce: BigInt,
    public new_micro_lbr_limit: BigInt
  ) {
    super();
  }
}
...
export class ScriptCallVariantUpdateExchangeRate extends ScriptCall {
  constructor(
    public currency: LibraTypes.TypeTag,
    public sliding_nonce: BigInt,
    public new_exchange_rate_numerator: BigInt,
    public new_exchange_rate_denominator: BigInt
  ) {
    super();
  }
}
...
export class ScriptCallVariantUpdateLibraVersion extends ScriptCall {
  constructor(public sliding_nonce: BigInt, public major: BigInt) {
    super();
  }
}
...
export class ScriptCallVariantUpdateMintingAbility extends ScriptCall {
  constructor(
    public currency: LibraTypes.TypeTag,
    public allow_minting: boolean
  ) {
    super();
  }
}

import { LcsSerializer } from '../lcs/lcsSerializer';
...
export class Stdlib {
   ...
   */
  static encodeAddCurrencyToAccountScript(
    currency: LibraTypes.TypeTag
  ): LibraTypes.Script {
    const code = Stdlib.ADD_CURRENCY_TO_ACCOUNT_CODE;
    const tyArgs: Seq<LibraTypes.TypeTag> = [currency];
    const args: Seq<LibraTypes.TransactionArgument> = [];
  ...
  static encodeAddRecoveryRotationCapabilityScript(
    ...
    const tyArgs: Seq<LibraTypes.TypeTag> = [];
    const args: Seq<LibraTypes.TransactionArgument> = [
   ...
   */
  static encodeAddToScriptAllowListScript(
    hash: Uint8Array,
   ...
   */
  static encodeAddValidatorAndReconfigureScript(
    sliding_nonce: BigInt,
   ...
   * * `Script::cancel_burn`
   */
  static encodeBurnTxnFeesScript(
    coin_type: LibraTypes.TypeTag
  ): LibraTypes.Script {
    const code = Stdlib.BURN_TXN_FEES_CODE;
    const tyArgs: Seq<LibraTypes.TypeTag> = [coin_type];
    const args: Seq<LibraTypes.TransactionArgument> = [];
    return new LibraTypes.Script(code, tyArgs, args);
  }
   ...
   * * `Script::create_recovery_address`
   */
  static encodeCreateChildVaspAccountScript(
    coin_type: LibraTypes.TypeTag,
   ...
   */
  static encodeCreateDesignatedDealerScript(
    currency: LibraTypes.TypeTag,
    sliding_nonce: BigInt,
   ...
   * * `Script::rotate_dual_attestation_info`
   */
  static encodeCreateParentVaspAccountScript(
    coin_type: LibraTypes.TypeTag,
    sliding_nonce: BigInt,
   ...
   * * `Script::set_validator_config_and_reconfigure`
   */
  static encodeCreateValidatorAccountScript(
    sliding_nonce: BigInt,
    new_account_address: LibraTypes.AccountAddress,
    auth_key_prefix: Uint8Array,
    human_name: Uint8Array
   ...
   * * `Script::set_validator_config_and_reconfigure`
   */
  static encodeCreateValidatorOperatorAccountScript(
    sliding_nonce: BigInt,
    new_account_address: LibraTypes.AccountAddress,
    auth_key_prefix: Uint8Array,
    human_name: Uint8Array
   ...
   */
  static encodeFreezeAccountScript(
    sliding_nonce: BigInt,
   ...
   * * `Script::add_currency_to_account`
   */
  static encodePeerToPeerWithMetadataScript(
    currency: LibraTypes.TypeTag,
   ...
   */
  static encodePublishSharedEd25519PublicKeyScript(
   ...
   * * `Script::set_validator_config_and_reconfigure`
   */
  static encodeRegisterValidatorConfigScript(
    ...
    const args: Seq<LibraTypes.TransactionArgument> = [
      ...
      new LibraTypes.TransactionArgumentVariantU8Vector(
   ...
   * * `Script::set_validator_config_and_reconfigure`
   */
  static encodeRemoveValidatorAndReconfigureScript(
    sliding_nonce: BigInt,
    validator_name: Uint8Array,
    validator_address: LibraTypes.AccountAddress
  ): LibraTypes.Script {
   ...
   * * `Script::rotate_authentication_key_with_recovery_address`
   */
  static encodeRotateAuthenticationKeyScript(
    new_key: Uint8Array
  ): LibraTypes.Script {
   ...
   * * `Script::rotate_authentication_key_with_recovery_address`
   */
  static encodeRotateAuthenticationKeyWithNonceScript(
    sliding_nonce: BigInt,
    new_key: Uint8Array
  ): LibraTypes.Script {
   ...
   * * `Script::rotate_authentication_key_with_recovery_address`
   */
  static encodeRotateAuthenticationKeyWithNonceAdminScript(
    sliding_nonce: BigInt,
    new_key: Uint8Array
  ): LibraTypes.Script {
   ...
   * * `Script::rotate_authentication_key_with_nonce_admin`
   */
  static encodeRotateAuthenticationKeyWithRecoveryAddressScript(
    recovery_address: LibraTypes.AccountAddress,
   ...
   * * `Script::rotate_dual_attestation_info`
   */
  static encodeRotateDualAttestationInfoScript(
    new_url: Uint8Array,
    new_key: Uint8Array
  ): LibraTypes.Script {
   ...
   * * `Script::publish_shared_ed25519_public_key`
   */
  static encodeRotateSharedEd25519PublicKeyScript(
    public_key: Uint8Array
  ): LibraTypes.Script {
   ...
   * * `Script::register_validator_config`
   */
  static encodeSetValidatorConfigAndReconfigureScript(
    validator_account: LibraTypes.AccountAddress,
    consensus_pubkey: Uint8Array,
    validator_network_addresses: Uint8Array,
    fullnode_network_addresses: Uint8Array
   ...
   * * `Script::set_validator_config_and_reconfigure`
   */
  static encodeSetValidatorOperatorScript(
   ...
   * * `Script::set_validator_config_and_reconfigure`
   */
  static encodeSetValidatorOperatorWithNonceAdminScript(
    sliding_nonce: BigInt,
    operator_name: Uint8Array,
    operator_account: LibraTypes.AccountAddress
  ): LibraTypes.Script {
  ...
  static encodeTieredMintScript(
    ...
    const args: Seq<LibraTypes.TransactionArgument> = [
      new LibraTypes.TransactionArgumentVariantU64(sliding_nonce),
      new LibraTypes.TransactionArgumentVariantAddress(
   ...
   */
  static encodeUnfreezeAccountScript(
    sliding_nonce: BigInt,
   ...
   */
  static encodeUpdateDualAttestationLimitScript(
    sliding_nonce: BigInt,
   ...
   * * `Scripts::update_minting_ability`
   */
  static encodeUpdateExchangeRateScript(
    currency: LibraTypes.TypeTag,
    sliding_nonce: BigInt,
    ...
    const args: Seq<LibraTypes.TransactionArgument> = [
      ...
      new LibraTypes.TransactionArgumentVariantU64(
   ...
   */
  static encodeUpdateLibraVersionScript(
    sliding_nonce: BigInt,
    major: BigInt
  ): LibraTypes.Script {
   ...
   * * `Scripts::update_exchange_rate`
   */
  static encodeUpdateMintingAbilityScript(
    currency: LibraTypes.TypeTag,
  ...
  static decodeAddCurrencyToAccountScript(
    script: LibraTypes.Script
  ): ScriptCallVariantAddCurrencyToAccount {
    return new ScriptCallVariantAddCurrencyToAccount(script.ty_args[0]);
  }

  static decodeAddRecoveryRotationCapabilityScript(
    script: LibraTypes.Script
  ): ScriptCallVariantAddRecoveryRotationCapability {
    return new ScriptCallVariantAddRecoveryRotationCapability(
      (script.args[0] as LibraTypes.TransactionArgumentVariantAddress).value
    );
  }

  static decodeAddToScriptAllowListScript(
    script: LibraTypes.Script
  ): ScriptCallVariantAddToScriptAllowList {
    return new ScriptCallVariantAddToScriptAllowList(
      (script.args[0] as LibraTypes.TransactionArgumentVariantU8Vector).value,
      (script.args[1] as LibraTypes.TransactionArgumentVariantU64).value
    );
  }

  static decodeAddValidatorAndReconfigureScript(
    script: LibraTypes.Script
  ): ScriptCallVariantAddValidatorAndReconfigure {
    return new ScriptCallVariantAddValidatorAndReconfigure(
      (script.args[0] as LibraTypes.TransactionArgumentVariantU64).value,
      (script.args[1] as LibraTypes.TransactionArgumentVariantU8Vector).value,
      (script.args[2] as LibraTypes.TransactionArgumentVariantAddress).value
    );
  }

  static decodeBurnScript(script: LibraTypes.Script): ScriptCallVariantBurn {
    return new ScriptCallVariantBurn(
      script.ty_args[0],
      (script.args[0] as LibraTypes.TransactionArgumentVariantU64).value,
      (script.args[1] as LibraTypes.TransactionArgumentVariantAddress).value
    );
  }

  static decodeBurnTxnFeesScript(
    script: LibraTypes.Script
  ): ScriptCallVariantBurnTxnFees {
    return new ScriptCallVariantBurnTxnFees(script.ty_args[0]);
  }

  static decodeCancelBurnScript(
    script: LibraTypes.Script
  ): ScriptCallVariantCancelBurn {
    return new ScriptCallVariantCancelBurn(
      script.ty_args[0],
      (script.args[0] as LibraTypes.TransactionArgumentVariantAddress).value
    );
  }

  static decodeCreateChildVaspAccountScript(
    script: LibraTypes.Script
  ): ScriptCallVariantCreateChildVaspAccount {
    return new ScriptCallVariantCreateChildVaspAccount(
      script.ty_args[0],
      (script.args[0] as LibraTypes.TransactionArgumentVariantAddress).value,
      (script.args[1] as LibraTypes.TransactionArgumentVariantU8Vector).value,
      (script.args[2] as LibraTypes.TransactionArgumentVariantBool).value,
      (script.args[3] as LibraTypes.TransactionArgumentVariantU64).value
    );
  }

  static decodeCreateDesignatedDealerScript(
    script: LibraTypes.Script
  ): ScriptCallVariantCreateDesignatedDealer {
    return new ScriptCallVariantCreateDesignatedDealer(
      script.ty_args[0],
      (script.args[0] as LibraTypes.TransactionArgumentVariantU64).value,
      (script.args[1] as LibraTypes.TransactionArgumentVariantAddress).value,
      (script.args[2] as LibraTypes.TransactionArgumentVariantU8Vector).value,
      (script.args[3] as LibraTypes.TransactionArgumentVariantU8Vector).value,
      (script.args[4] as LibraTypes.TransactionArgumentVariantBool).value
    );
  }

  static decodeCreateParentVaspAccountScript(
    script: LibraTypes.Script
  ): ScriptCallVariantCreateParentVaspAccount {
    return new ScriptCallVariantCreateParentVaspAccount(
      script.ty_args[0],
      (script.args[0] as LibraTypes.TransactionArgumentVariantU64).value,
      (script.args[1] as LibraTypes.TransactionArgumentVariantAddress).value,
      (script.args[2] as LibraTypes.TransactionArgumentVariantU8Vector).value,
  ...
  static decodeCreateRecoveryAddressScript(
    _script: LibraTypes.Script
  ): ScriptCallVariantCreateRecoveryAddress {
    return new ScriptCallVariantCreateRecoveryAddress();
  }

  static decodeCreateValidatorAccountScript(
    script: LibraTypes.Script
  ): ScriptCallVariantCreateValidatorAccount {
    return new ScriptCallVariantCreateValidatorAccount(
      (script.args[0] as LibraTypes.TransactionArgumentVariantU64).value,
      (script.args[1] as LibraTypes.TransactionArgumentVariantAddress).value,
      (script.args[2] as LibraTypes.TransactionArgumentVariantU8Vector).value,
      (script.args[3] as LibraTypes.TransactionArgumentVariantU8Vector).value
  ...
  static decodeCreateValidatorOperatorAccountScript(
    script: LibraTypes.Script
  ): ScriptCallVariantCreateValidatorOperatorAccount {
    return new ScriptCallVariantCreateValidatorOperatorAccount(
      (script.args[0] as LibraTypes.TransactionArgumentVariantU64).value,
      (script.args[1] as LibraTypes.TransactionArgumentVariantAddress).value,
      (script.args[2] as LibraTypes.TransactionArgumentVariantU8Vector).value,
      (script.args[3] as LibraTypes.TransactionArgumentVariantU8Vector).value
  ...
  static decodeFreezeAccountScript(
    script: LibraTypes.Script
  ): ScriptCallVariantFreezeAccount {
    return new ScriptCallVariantFreezeAccount(
      (script.args[0] as LibraTypes.TransactionArgumentVariantU64).value,
      (script.args[1] as LibraTypes.TransactionArgumentVariantAddress).value
    );
  }

  static decodePeerToPeerWithMetadataScript(
    script: LibraTypes.Script
  ): ScriptCallVariantPeerToPeerWithMetadata {
    return new ScriptCallVariantPeerToPeerWithMetadata(
      script.ty_args[0],
      (script.args[0] as LibraTypes.TransactionArgumentVariantAddress).value,
      (script.args[1] as LibraTypes.TransactionArgumentVariantU64).value,
      (script.args[2] as LibraTypes.TransactionArgumentVariantU8Vector).value,
  ...
  static decodePreburnScript(
    script: LibraTypes.Script
  ): ScriptCallVariantPreburn {
    return new ScriptCallVariantPreburn(
      script.ty_args[0],
      (script.args[0] as LibraTypes.TransactionArgumentVariantU64).value
    );
  }

  static decodePublishSharedEd25519PublicKeyScript(
    script: LibraTypes.Script
  ): ScriptCallVariantPublishSharedEd25519PublicKey {
    return new ScriptCallVariantPublishSharedEd25519PublicKey(
      (script.args[0] as LibraTypes.TransactionArgumentVariantU8Vector).value
    );
  }

  static decodeRegisterValidatorConfigScript(
    script: LibraTypes.Script
  ): ScriptCallVariantRegisterValidatorConfig {
    return new ScriptCallVariantRegisterValidatorConfig(
      (script.args[0] as LibraTypes.TransactionArgumentVariantAddress).value,
      (script.args[1] as LibraTypes.TransactionArgumentVariantU8Vector).value,
      (script.args[2] as LibraTypes.TransactionArgumentVariantU8Vector).value,
      (script.args[3] as LibraTypes.TransactionArgumentVariantU8Vector).value
  ...
  static decodeRemoveValidatorAndReconfigureScript(
    script: LibraTypes.Script
  ): ScriptCallVariantRemoveValidatorAndReconfigure {
    return new ScriptCallVariantRemoveValidatorAndReconfigure(
      (script.args[0] as LibraTypes.TransactionArgumentVariantU64).value,
      (script.args[1] as LibraTypes.TransactionArgumentVariantU8Vector).value,
      (script.args[2] as LibraTypes.TransactionArgumentVariantAddress).value
    );
  ...
  static decodeRotateAuthenticationKeyScript(
    script: LibraTypes.Script
  ): ScriptCallVariantRotateAuthenticationKey {
    return new ScriptCallVariantRotateAuthenticationKey(
      (script.args[0] as LibraTypes.TransactionArgumentVariantU8Vector).value
    );
  }

  static decodeRotateAuthenticationKeyWithNonceScript(
    script: LibraTypes.Script
  ): ScriptCallVariantRotateAuthenticationKeyWithNonce {
    return new ScriptCallVariantRotateAuthenticationKeyWithNonce(
      (script.args[0] as LibraTypes.TransactionArgumentVariantU64).value,
      (script.args[1] as LibraTypes.TransactionArgumentVariantU8Vector).value
    );
  }

  static decodeRotateAuthenticationKeyWithNonceAdminScript(
    script: LibraTypes.Script
  ): ScriptCallVariantRotateAuthenticationKeyWithNonceAdmin {
    return new ScriptCallVariantRotateAuthenticationKeyWithNonceAdmin(
      (script.args[0] as LibraTypes.TransactionArgumentVariantU64).value,
      (script.args[1] as LibraTypes.TransactionArgumentVariantU8Vector).value
    );
  }

  static decodeRotateAuthenticationKeyWithRecoveryAddressScript(
    script: LibraTypes.Script
  ): ScriptCallVariantRotateAuthenticationKeyWithRecoveryAddress {
    return new ScriptCallVariantRotateAuthenticationKeyWithRecoveryAddress(
      (script.args[0] as LibraTypes.TransactionArgumentVariantAddress).value,
      (script.args[1] as LibraTypes.TransactionArgumentVariantAddress).value,
      (script.args[2] as LibraTypes.TransactionArgumentVariantU8Vector).value
    );
  ...
  static decodeRotateDualAttestationInfoScript(
    script: LibraTypes.Script
  ): ScriptCallVariantRotateDualAttestationInfo {
    return new ScriptCallVariantRotateDualAttestationInfo(
      (script.args[0] as LibraTypes.TransactionArgumentVariantU8Vector).value,
      (script.args[1] as LibraTypes.TransactionArgumentVariantU8Vector).value
    );
  }

  static decodeRotateSharedEd25519PublicKeyScript(
    script: LibraTypes.Script
  ): ScriptCallVariantRotateSharedEd25519PublicKey {
    return new ScriptCallVariantRotateSharedEd25519PublicKey(
      (script.args[0] as LibraTypes.TransactionArgumentVariantU8Vector).value
    );
  }

  static decodeSetValidatorConfigAndReconfigureScript(
    script: LibraTypes.Script
  ): ScriptCallVariantSetValidatorConfigAndReconfigure {
    return new ScriptCallVariantSetValidatorConfigAndReconfigure(
      (script.args[0] as LibraTypes.TransactionArgumentVariantAddress).value,
      (script.args[1] as LibraTypes.TransactionArgumentVariantU8Vector).value,
      (script.args[2] as LibraTypes.TransactionArgumentVariantU8Vector).value,
      (script.args[3] as LibraTypes.TransactionArgumentVariantU8Vector).value
  ...
  static decodeSetValidatorOperatorScript(
    script: LibraTypes.Script
  ): ScriptCallVariantSetValidatorOperator {
    return new ScriptCallVariantSetValidatorOperator(
      (script.args[0] as LibraTypes.TransactionArgumentVariantU8Vector).value,
      (script.args[1] as LibraTypes.TransactionArgumentVariantAddress).value
    );
  }

  static decodeSetValidatorOperatorWithNonceAdminScript(
    script: LibraTypes.Script
  ): ScriptCallVariantSetValidatorOperatorWithNonceAdmin {
    return new ScriptCallVariantSetValidatorOperatorWithNonceAdmin(
      (script.args[0] as LibraTypes.TransactionArgumentVariantU64).value,
      (script.args[1] as LibraTypes.TransactionArgumentVariantU8Vector).value,
      (script.args[2] as LibraTypes.TransactionArgumentVariantAddress).value
    );
  ...
  static decodeTieredMintScript(
    script: LibraTypes.Script
  ): ScriptCallVariantTieredMint {
    return new ScriptCallVariantTieredMint(
      script.ty_args[0],
      (script.args[0] as LibraTypes.TransactionArgumentVariantU64).value,
      (script.args[1] as LibraTypes.TransactionArgumentVariantAddress).value,
      (script.args[2] as LibraTypes.TransactionArgumentVariantU64).value,
      (script.args[3] as LibraTypes.TransactionArgumentVariantU64).value
    );
  }

  static decodeUnfreezeAccountScript(
    script: LibraTypes.Script
  ): ScriptCallVariantUnfreezeAccount {
    return new ScriptCallVariantUnfreezeAccount(
      (script.args[0] as LibraTypes.TransactionArgumentVariantU64).value,
      (script.args[1] as LibraTypes.TransactionArgumentVariantAddress).value
    );
  }

  static decodeUpdateDualAttestationLimitScript(
    script: LibraTypes.Script
  ): ScriptCallVariantUpdateDualAttestationLimit {
    return new ScriptCallVariantUpdateDualAttestationLimit(
      (script.args[0] as LibraTypes.TransactionArgumentVariantU64).value,
      (script.args[1] as LibraTypes.TransactionArgumentVariantU64).value
    );
  }

  static decodeUpdateExchangeRateScript(
    script: LibraTypes.Script
  ): ScriptCallVariantUpdateExchangeRate {
    return new ScriptCallVariantUpdateExchangeRate(
      script.ty_args[0],
      (script.args[0] as LibraTypes.TransactionArgumentVariantU64).value,
      (script.args[1] as LibraTypes.TransactionArgumentVariantU64).value,
      (script.args[2] as LibraTypes.TransactionArgumentVariantU64).value
  ...
  static decodeUpdateLibraVersionScript(
    script: LibraTypes.Script
  ): ScriptCallVariantUpdateLibraVersion {
    return new ScriptCallVariantUpdateLibraVersion(
      (script.args[0] as LibraTypes.TransactionArgumentVariantU64).value,
      (script.args[1] as LibraTypes.TransactionArgumentVariantU64).value
    );
  }

  static decodeUpdateMintingAbilityScript(
    script: LibraTypes.Script
  ): ScriptCallVariantUpdateMintingAbility {
    return new ScriptCallVariantUpdateMintingAbility(
      script.ty_args[0],
      (script.args[0] as LibraTypes.TransactionArgumentVariantBool).value
    );
  }

  static ADD_CURRENCY_TO_ACCOUNT_CODE = Stdlib.fromHexString(
    'a11ceb0b0100000006010002030206040802050a0707111a082b100000000100010101000201060c000109000c4c696272614163636f756e740c6164645f63757272656e63790000000000000000000000000000000101010001030b00380002'
  );

  static ADD_RECOVERY_ROTATION_CAPABILITY_CODE = Stdlib.fromHexString(
    ''
  );

  static ADD_TO_SCRIPT_ALLOW_LIST_CODE = Stdlib.fromHexString(
    ''
  );

  static ADD_VALIDATOR_AND_RECONFIGURE_CODE = Stdlib.fromHexString(
    ''
  );

  static BURN_CODE = Stdlib.fromHexString(
    ''
  );

  static BURN_TXN_FEES_CODE = Stdlib.fromHexString(
    'a11ceb0b0100000006010002030206040802050a07071119082a100000000100010101000201060c000109000e5472616e73616374696f6e466565096275726e5f666565730000000000000000000000000000000101010001030b00380002'
  );

  static CANCEL_BURN_CODE = Stdlib.fromHexString(
    'a11ceb0b0100000006010002030206040802050a08071219082b100000000100010101000202060c05000109000c4c696272614163636f756e740b63616e63656c5f6275726e0000000000000000000000000000000101010001040b000a01380002'
  );

  static CREATE_CHILD_VASP_ACCOUNT_CODE = Stdlib.fromHexString(
    ''
  );

  static CREATE_DESIGNATED_DEALER_CODE = Stdlib.fromHexString(
    ''
  );

  static CREATE_PARENT_VASP_ACCOUNT_CODE = Stdlib.fromHexString(
    ''
  );

  static CREATE_RECOVERY_ADDRESS_CODE = Stdlib.fromHexString(
    ''
  );

  static CREATE_VALIDATOR_ACCOUNT_CODE = Stdlib.fromHexString(
    ''
  );

  static CREATE_VALIDATOR_OPERATOR_ACCOUNT_CODE = Stdlib.fromHexString(
    ''
  );

  static FREEZE_ACCOUNT_CODE = Stdlib.fromHexString(
    ''
  );

  static PEER_TO_PEER_WITH_METADATA_CODE = Stdlib.fromHexString(
  ...
  static PREBURN_CODE = Stdlib.fromHexString(
    ''
  );

  static PUBLISH_SHARED_ED25519_PUBLIC_KEY_CODE = Stdlib.fromHexString(
    'a11ceb0b0100000005010002030205050706070d1f082c100000000100010002060c0a020016536861726564456432353531395075626c69634b6579077075626c69736800000000000000000000000000000001000001040b000b01110002'
  );

  static REGISTER_VALIDATOR_CONFIG_CODE = Stdlib.fromHexString(
    'a11ceb0b010000000501000203020505070b07121b082d100000000100010005060c050a020a020a02000f56616c696461746f72436f6e6669670a7365745f636f6e66696700000000000000000000000000000001000001070b000a010b020b030b04110002'
  );

  static REMOVE_VALIDATOR_AND_RECONFIGURE_CODE = Stdlib.fromHexString(
    ''
  );

  static ROTATE_AUTHENTICATION_KEY_CODE = Stdlib.fromHexString(
    ''
  );

  static ROTATE_AUTHENTICATION_KEY_WITH_NONCE_CODE = Stdlib.fromHexString(
    ''
  );

  static ROTATE_AUTHENTICATION_KEY_WITH_NONCE_ADMIN_CODE = Stdlib.fromHexString(
    ''
  );

  static ROTATE_AUTHENTICATION_KEY_WITH_RECOVERY_ADDRESS_CODE = Stdlib.fromHexString(
    'a11ceb0b0100000005010002030205050708070f2a0839100000000100010004060c05050a02000f5265636f766572794164647265737319726f746174655f61757468656e7469636174696f6e5f6b657900000000000000000000000000000001000001060b000a010a020b03110002'
  );

  static ROTATE_DUAL_ATTESTATION_INFO_CODE = Stdlib.fromHexString(
    ''
  );

  static ROTATE_SHARED_ED25519_PUBLIC_KEY_CODE = Stdlib.fromHexString(
    'a11ceb0b0100000005010002030205050706070d22082f100000000100010002060c0a020016536861726564456432353531395075626c69634b65790a726f746174655f6b657900000000000000000000000000000001000001040b000b01110002'
  );

  static SET_VALIDATOR_CONFIG_AND_RECONFIGURE_CODE = Stdlib.fromHexString(
    ''
  );

  static SET_VALIDATOR_OPERATOR_CODE = Stdlib.fromHexString(
    ''
  );

  static SET_VALIDATOR_OPERATOR_WITH_NONCE_ADMIN_CODE = Stdlib.fromHexString(
    ''
  );

  static TIERED_MINT_CODE = Stdlib.fromHexString(
    ''
  );

  static UNFREEZE_ACCOUNT_CODE = Stdlib.fromHexString(
    ''
  );

  static UPDATE_DUAL_ATTESTATION_LIMIT_CODE = Stdlib.fromHexString(
    ''
  );

  static UPDATE_EXCHANGE_RATE_CODE = Stdlib.fromHexString(
    ''
  );

  static UPDATE_LIBRA_VERSION_CODE = Stdlib.fromHexString(
    ''
  );

  static UPDATE_MINTING_ABILITY_CODE = Stdlib.fromHexString(
    'a11ceb0b0100000006010002030206040802050a0807121d082f100000000100010101000202060c0100010900054c69627261167570646174655f6d696e74696e675f6162696c6974790000000000000000000000000000000101010001040b000a01380002'
  );
  ...
  static ScriptArgs: { [name: string]: ScriptDef } = {
    ...
    RotateAuthenticationKeyWithNonceAdmin: {
      stdlibEncodeFunction:
        Stdlib.encodeRotateAuthenticationKeyWithNonceAdminScript,
      stdlibDecodeFunction:
        Stdlib.decodeRotateAuthenticationKeyWithNonceAdminScript,
    ...
    RotateAuthenticationKeyWithRecoveryAddress: {
      stdlibEncodeFunction:
        Stdlib.encodeRotateAuthenticationKeyWithRecoveryAddressScript,
      stdlibDecodeFunction:
        Stdlib.decodeRotateAuthenticationKeyWithRecoveryAddressScript,
    ...
    SetValidatorOperatorWithNonceAdmin: {
      stdlibEncodeFunction:
        Stdlib.encodeSetValidatorOperatorWithNonceAdminScript,
      stdlibDecodeFunction:
        Stdlib.decodeSetValidatorOperatorWithNonceAdminScript,
...
export type ScriptDecoders = {
  User: {
    AddCurrencyToAccount: (
      type: string,
      currency: LibraTypes.TypeTagVariantStruct
    ) => void;
    AddRecoveryRotationCapability: (
      type: string,
      recoveryAddress: LibraTypes.TransactionArgumentVariantAddress
    ) => void;
    AddToScriptAllowList: (
      type: string,
      hash: LibraTypes.TransactionArgumentVariantU8Vector,
      slidingNonce: LibraTypes.TransactionArgumentVariantU64
    ) => void;
    AddValidatorAndReconfigure: (
      type: string,
      slidingNonce: LibraTypes.TransactionArgumentVariantU64,
      validatorName: LibraTypes.TransactionArgumentVariantU8Vector,
      validatorAddress: LibraTypes.TransactionArgumentVariantAddress
    ) => void;
    Burn: (
      type: string,
      token: LibraTypes.TypeTagVariantStruct,
      slidingNonce: LibraTypes.TransactionArgumentVariantU64,
      preburnAddress: LibraTypes.TransactionArgumentVariantAddress
    ) => void;
    BurnTxnFees: (
      type: string,
      coinType: LibraTypes.TypeTagVariantStruct
    ) => void;
    CancelBurn: (
      type: string,
      token: LibraTypes.TypeTagVariantStruct,
    ...
    CreateChildVaspAccount: (
      type: string,
      coinType: LibraTypes.TypeTagVariantStruct,
      childAddress: LibraTypes.TransactionArgumentVariantAddress,
      authKeyPrefix: LibraTypes.TransactionArgumentVariantU8Vector,
      addAllCurrencies: LibraTypes.TransactionArgumentVariantBool,
      childInitialBalance: LibraTypes.TransactionArgumentVariantU64
    ) => void;
    CreateDesignatedDealer: (
      type: string,
      currency: LibraTypes.TypeTagVariantStruct,
      slidingNonce: LibraTypes.TransactionArgumentVariantU64,
      addr: LibraTypes.TransactionArgumentVariantAddress,
      authKeyPrefix: LibraTypes.TransactionArgumentVariantU8Vector,
      humanName: LibraTypes.TransactionArgumentVariantU8Vector,
      addAllCurrencies: LibraTypes.TransactionArgumentVariantBool
    ) => void;
    CreateParentVaspAccount: (
      type: string,
      coinType: LibraTypes.TypeTagVariantStruct,
      slidingNonce: LibraTypes.TransactionArgumentVariantU64,
      newAccountAddress: LibraTypes.TransactionArgumentVariantAddress,
      authKeyPrefix: LibraTypes.TransactionArgumentVariantU8Vector,
      humanName: LibraTypes.TransactionArgumentVariantU8Vector,
      addAllCurrencies: LibraTypes.TransactionArgumentVariantBool
    ) => void;
    ...
    FreezeAccount: (
      type: string,
      slidingNonce: LibraTypes.TransactionArgumentVariantU64,
      toFreezeAccount: LibraTypes.TransactionArgumentVariantAddress
    ) => void;
    PeerToPeerWithMetadata: (
      type: string,
      currency: LibraTypes.TypeTagVariantStruct,
      payee: LibraTypes.TransactionArgumentVariantAddress,
      amount: LibraTypes.TransactionArgumentVariantU64,
      metadata: LibraTypes.TransactionArgumentVariantU8Vector,
      metadataSignature: LibraTypes.TransactionArgumentVariantU8Vector
    ) => void;
    Preburn: (
      type: string,
      token: LibraTypes.TypeTagVariantStruct,
    ...
    PublishSharedEd25519PublicKey: (
      type: string,
      publicKey: LibraTypes.TransactionArgumentVariantU8Vector
    ) => void;
    RegisterValidatorConfig: (
      type: string,
      validatorAccount: LibraTypes.TransactionArgumentVariantAddress,
      consensusPubkey: LibraTypes.TransactionArgumentVariantU8Vector,
      validatorNetworkAddresses: LibraTypes.TransactionArgumentVariantU8Vector,
      fullnodeNetworkAddresses: LibraTypes.TransactionArgumentVariantU8Vector
    ) => void;
    RemoveValidatorAndReconfigure: (
      type: string,
      slidingNonce: LibraTypes.TransactionArgumentVariantU64,
    ...
    RotateAuthenticationKey: (
      type: string,
      newKey: LibraTypes.TransactionArgumentVariantU8Vector
    ) => void;
    RotateAuthenticationKeyWithNonce: (
      type: string,
      slidingNonce: LibraTypes.TransactionArgumentVariantU64,
    ...
    RotateAuthenticationKeyWithRecoveryAddress: (
      type: string,
      recoveryAddress: LibraTypes.TransactionArgumentVariantAddress,
      toRecover: LibraTypes.TransactionArgumentVariantAddress,
      newKey: LibraTypes.TransactionArgumentVariantU8Vector
    ) => void;
    RotateDualAttestationInfo: (
      type: string,
      newUrl: LibraTypes.TransactionArgumentVariantU8Vector,
      newKey: LibraTypes.TransactionArgumentVariantU8Vector
    ) => void;
    RotateSharedEd25519PublicKey: (
      type: string,
    ...
    SetValidatorOperator: (
      type: string,
      operatorName: LibraTypes.TransactionArgumentVariantU8Vector,
      operatorAccount: LibraTypes.TransactionArgumentVariantAddress
    ) => void;
    SetValidatorOperatorWithNonceAdmin: (
      type: string,
      slidingNonce: LibraTypes.TransactionArgumentVariantU64,
    ...
    TieredMint: (
      ...
      coinType: LibraTypes.TypeTagVariantStruct,
      slidingNonce: LibraTypes.TransactionArgumentVariantU64,
      designatedDealerAddress: LibraTypes.TransactionArgumentVariantAddress,
      mintAmount: LibraTypes.TransactionArgumentVariantU64,
      tierIndex: LibraTypes.TransactionArgumentVariantU64
    ) => void;
    UnfreezeAccount: (
      type: string,
      slidingNonce: LibraTypes.TransactionArgumentVariantU64,
      toUnfreezeAccount: LibraTypes.TransactionArgumentVariantAddress
    ) => void;
    UpdateDualAttestationLimit: (
      type: string,
      slidingNonce: LibraTypes.TransactionArgumentVariantU64,
      newMicroLbrLimit: LibraTypes.TransactionArgumentVariantU64
    ) => void;
    UpdateExchangeRate: (
      type: string,
      currency: LibraTypes.TypeTagVariantStruct,
      slidingNonce: LibraTypes.TransactionArgumentVariantU64,
      newExchangeRateNumerator: LibraTypes.TransactionArgumentVariantU64,
      newExchangeRateDenominator: LibraTypes.TransactionArgumentVariantU64
    ) => void;
    UpdateLibraVersion: (
      type: string,
      slidingNonce: LibraTypes.TransactionArgumentVariantU64,
      major: LibraTypes.TransactionArgumentVariantU64
    ) => void;
    UpdateMintingAbility: (
      type: string,
      currency: LibraTypes.TypeTagVariantStruct,
      allowMinting: LibraTypes.TransactionArgumentVariantBool
    ) => void;
